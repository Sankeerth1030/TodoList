...
export default function Home() {
  ...
  const AddTodo = (title: string, desc: string) => {
    const newTodo: Todo = {
      ...
      title: title,
      description: desc,
      isCompleted: true, //false changed to true
      isUrgent: true, //false changed to true
    };

    //! todos.push(newTodo); // Removed
    //! setTodos(todos); //Removed
    setTodos((prevTodos) => [...prevTodos, newTodo]); //! Added
  };
